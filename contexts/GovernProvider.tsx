...
export const GovernProvider: React.FC<React.ReactNode> = ({ children }) => {
  ...
  return (
    <GovernContext.Provider value={{ stakeWrapper, lockerWrapper }}>
      {children}
    </GovernContext.Provider>
  );
};

export const useGovernContext = () => {
  const context = useContext(GovernContext);
